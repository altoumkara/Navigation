...
private static class ColorPickerView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (Color.red(mCurrentColor) + Color.green(mCurrentColor)
            ...
            mPaint.setColor(Color.BLACK);
        canvas.drawText("getResources().getString(R.string.settings_bg_color_confirm)", 74,
                340, mPaint);
        ...
        if (Color.red(mDefaultColor) + Color.green(mDefaultColor)
            ...
            mPaint.setColor(Color.BLACK);
        canvas.drawText("getResources().getString( R.string.settings_default_color_confirm)", 202, 340,
                mPaint);
    }
